...
def excluir_arquivos_em_diretorio(diretorio, pasta):
    if pasta:
...
def configure_exec():
    ...
    try:
        if file_exists(v_file_last_load):
            ...
            data_inicio_carga_glosa = '2025-06-01 00:00:00'
            ...
            data_inicio_carga = '2025-06-01 00:00:00'
...
def process_data(dt_inicio_exec_carga, data_inicio_carga, data_fim_carga, tipo_carga):
    ...
    try:
        ...
        for i in range(0, total_medicos, tamanho_lote):
            ...
            excluir_arquivos_em_diretorio(output_filename_csv, pasta=False)
